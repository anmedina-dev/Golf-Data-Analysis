...
*/
  ...
  const getTournScores = async () => {
    if (sYear && sTourney) {
      const res = await axios.get(
        `https://golf-da-api.onrender.com/api/golf/everytourney/${sYear.value}/${sTourney.value}`
      );
      const data = res.data;
      setScores(data);
    } else {
      const res = await axios.get("https://golf-da-api.onrender.com/api/golf");
      const data = res.data;
      setScores(data);
    }
  };
  ...
  const getThemYears = async () => {
    const res = await axios.get(
      "https://golf-da-api.onrender.com/api/golf/getyears"
    );
    const data = res.data;
  ...
  const getTournDropdown = async () => {
    const res = await axios.get(
      `https://golf-da-api.onrender.com/api/golf/specificyear/${sYear.value}`
    );
    const data = res.data;
  ...
  const getPlayerDropdown = async () => {
    const res = await axios.get(
      `https://golf-da-api.onrender.com/api/golf/player/${sYear.value}/${sTourney.value}`
    );
    const data = res.data;
  ...
  const getPlayerStats = async () => {
    const res = await axios.get(
      `https://golf-da-api.onrender.com/api/golf/stat/${sPlayer.value}`
    );
    const data = res.data;
    //console.log(data)
    setStats(data);
  ...
  const getDistinctPlayedYears = async () => {
    const res = await axios.get(
      `https://golf-da-api.onrender.com/api/golf/distinctyearsplayed/${sPlayer.value}`
    );
    const data = res.data;
    //console.log(data)
  ...
  const getRankTWAvg = async () => {
    ...
    for (i = 0; i < distinctPlayerYears.length; i++) {
      const res = await axios.get(
        `https://golf-da-api.onrender.com/api/golf/ranktw/${distinctPlayerYears[i]}/${sPlayer.value}`
      );
      const data = res.data;
      let sum = 0;
  ...
  const getPlayerPlayedTourneysInYear = async () => {
    const res = await axios.get(
      `https://golf-da-api.onrender.com/api/golf/playedtournsyear/${sYear.value}/${sPlayer.value}`
    );
    const data = res.data;
  ...
  const getPlayerRanksInYear = async () => {
    const res = await axios.get(
      `https://golf-da-api.onrender.com/api/golf/playerranksinyear/${sYear.value}/${sPlayer.value}`
    );
    const data = res.data;
    let fixedData = [];
    var x;
  ...
  const getPlayerScoresInYear = async () => {
    const res = await axios.get(
      `https://golf-da-api.onrender.com/api/golf/playerscoresinyear/${sYear.value}/${sPlayer.value}`
    );
    const data = res.data;
    let fixedData = [];
    var x;
    ...
    <div className="App">
      <div className="DataInput">
        ...
        <Dropdown
          options={tourneys}
          value={sTourney}
          onChange={newTourneySetter}
          placeholder="Select a tournament"
        />
        <Dropdown
          options={playerTourns}
          value={sPlayer}
          onChange={newPlayerDropSetter}
